...
Independent local copy of `hkrizic.github.io`. The original checkout has not been changed and nothing has been published.
...
Open http://localhost:4321. No install or build is required.

## Design and interactions

- Physics leads: a live WebGL gravitational lens, restrained blue light, oversized typography, and a contrasting editorial biography.
